Lo que quice hacer es una pagina que simule un login, donde el usuario luego de ingresar la contraseña y necesite verificar mediante el boton de show password que contraseña ingreso, el boton se mueva de manera que no pueda hacer clic para visualizar el texto ingresado , pero luego del tercer intento ya puede hacerlo. lo hice con chatgpt
1 - Prompt inicial
